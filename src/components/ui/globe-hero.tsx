...
>(({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="relative z-10 flex flex-col items-center justify-center h-full pb-20 md:pb-28">
        {children}
      </div>
      
      <div className="absolute inset-0 z-0 pointer-events-none -translate-y-10 md:-translate-y-14">
        <Canvas>
