...
const HeroSection = React.forwardRef<HTMLDivElement, HeroSectionProps>(
  ({ className, logo, slogan, title, subtitle, callToAction, backgroundImage, contactInfo, ...props }, ref) => {
    ...
    return (
      ...
      >
        {/* Left Side: Content */}
        <div className="flex w-full flex-col justify-between p-6 md:w-1/2 md:p-10 lg:w-3/5 lg:p-12">
            ...
            <div>
                ...
                <motion.main variants={containerVariants}>
                    ...
                    <motion.div className="my-4 h-1 w-20 bg-primary" variants={itemVariants}></motion.div>
                    <motion.div className="mb-6 max-w-2xl text-base text-muted-foreground" variants={itemVariants}>
                        {subtitle}
                    </motion.div>
        ...
        <motion.div 
          className="w-full min-h-[240px] bg-cover bg-center md:w-1/2 md:min-h-full lg:w-2/5"
          style={{ 
